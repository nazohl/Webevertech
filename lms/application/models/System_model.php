...
class System_model extends CI_Model
{
    ...
    {
        parent::__construct();
        if (isset($this->session->userdata['time_zone']))
        {
    ...
    public function update_paypal_info()
    {
        ...
        switch ($name) {
            case 'pp_app_id':
                $data['application_id'] = $this->input->post('value', TRUE);
                break;
            case 'commission':
                $data['commission_percent'] = $this->input->post('value', TRUE);
                break;
            case 'pp_email':
                $data['paypal_email'] = $this->input->post('value', TRUE);
                break;
            case 'pp_sandbox':
    ...
    public function update_payu_info()
    {
        ...
        switch ($name) {
            case 'payu_sandbox':
                $data['sandbox'] = $this->input->post('value', TRUE);
                break;
            case 'payu_merchant_key':
                $data['merchant_key'] = $this->input->post('value', TRUE);
                break;
            case 'payu_salt':
                $data['salt'] = $this->input->post('value', TRUE);
                break;
            default:
                return FALSE;
                break;
