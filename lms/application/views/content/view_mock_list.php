<section id="internal-slider" class="carousel">
  <div class="container">
    <h1>
      <?=isset($category_name)?$category_name:'All Exams'; ?>
    </h1>
  </div>
</section>
<section id="exams">
  <div class="coursedropdownbar">
    <div class="container">
      <div class="coursedropbox">
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 nopadding">
          <ul class="nav  category-menu" style="float:left;">
            <li class="dropdown"> <a href="#" class="dropdown-toggle disabled" data-toggle="dropdown"><i class=" fa fa-sitemap"></i> &nbsp;All Categories <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                ...
                <li class="dropdown-submenu"> <a href="#" tabindex="-1" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <h3><i class="fa fa-code-fork"></i>
                      <?=$value->category_name; ?>
                    </h3>
                    <?php foreach ($sub as $sub_cat) { ?>
                    <li> <a href="<?=base_url('index.php/category/'.$sub_cat->id); ?>">
      ...
      <div class="courseshortlist">
        <?php if ($commercial) { ?>
        <div class="pull-right"> <a href="<?=base_url('index.php/exam_control/view_all_mocks') ?>">All</a> <a href="<?=base_url('index.php/exam_control/mocks_type/paid') ?>">Paid</a> <a href="<?=base_url('index.php/exam_control/mocks_type/free') ?>">Free</a> </div>
        <?php } ?>
      </div>
    </div>
  </div>
        ...
        <div class="col-lg-12 col-md-9 col-sm-12 col-xs-12 nopadding">
          ...
          <div class="exam-list">
            <?php
	                ...
	                ?>
            <div class="col-lg-3 col-md-4 col-xs-12 col-sm-6 exam-item"> <span style="position: absolute; right: 15px; top: 40px; font-weight: lighter; font-size:18px;">
              ...
              <div class="thumbnail"> <a href="<?=base_url('index.php/exam_control/view_exam_summary/'.$mock->title_id); ?>">
                ...
                <?php } ?>
                <div class="categoryandls"> <strong>Category</strong>:
                  <?=$mock->category_name.'/'.$mock->sub_cat_name;?>
                  <br />
                ...
                <div class="caption"> <span class="exam-title">
                  <?=$mock->title_name;?>
                  </span>
                  <button class="homecoursebutton">Start</button>
