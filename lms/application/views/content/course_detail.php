...
<!--                <a class="btn custom_navbar-btn btn-primary pull-right col-sm-2" href="<?=base_url('index.php/course/add_content/'.$courses->course_id); ?>"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; Add Content</a>
                <a class="btn custom_navbar-btn btn-primary pull-right col-sm-2" href="<?=base_url('index.php/course/add_exam/'.$courses->course_id); ?>"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; Add Section Exam</a>-->
            <?php 
            } ?>
            </p>
        </div>
    ...
    <div class="col-sm-12">
        ...
        <li id="ID_<?=$section->section_id;?>" class="ui-state-default list-group-item">
            <ul class="inner-sortlist">
                <li style="width: 60%;"><a id="section_title-<?=$section->section_id;?>" ><?=$section->section_name.': '.$section->section_title; ?></a></li>
                <li><?=$this->db->where('course_id', $courses->course_id)->where('section_id', $section->section_id)->from('course_videos')->count_all_results(); ?> videos</li>                                
                <li><?=$section->exams?> Exams</li>    
                <li class="pull-right">
