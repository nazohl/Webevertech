...
<!--                <a class="btn custom_navbar-btn btn-primary pull-right col-sm-2" href="<?=base_url('index.php/course/add_exam/'.$section->course_id.'/'.$section->section_id); ?>"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; Add Section Exam</a>-->
