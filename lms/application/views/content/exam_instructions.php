            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-12 col-md-offset-1 col-sm-offset-0">
                    <ol class="breadcrumb hidden-print">
                        ...
                        <li><a href="<?=base_url('index.php/exam_control/view_exam_summary/' . $mock->title_id) ?>"><i class="fa fa-tasks"></i> Exam Summery</a></li>
                    ...
                    if ($this->session->userdata('log')) {  ?>
                        <a href="<?=base_url('index.php/exam_control/start_exam/'.$mock->title_id) ?>" class="btn btn-success col-xs-5"> Start Exam </a>
