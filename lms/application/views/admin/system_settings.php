...
<head>
    ...
    <link href="<?=base_url('assets/font-awesome/css/font-awesome.css') ?>" rel="stylesheet" media="screen">
    <link href="<?=base_url('assets/fuelux/css/fuelux.min.css') ?>" rel="stylesheet" media="screen">
    <link href="<?=base_url('assets/fuelux/css/fuelux-responsive.min.css') ?>" rel="stylesheet" media="screen">
</head>
<body>
    <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8 col-xs-offset-1 col-xs-10">
                ...
                <?=form_open(base_url() . 'index.php/admin/system_control/set_system_config', 'role="form" class="form-horizontal"'); ?>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('user_name', set_value('user_name'), 'id="user_name" placeholder="Full Name" class="form-control" required="required"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="user_email" class="col-md-2 col-md-offset-1 col-sm-3 control-label hidden-xs">Email: *</label>
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('user_email',  set_value('user_email'), 'pattern="^[a-zA-Z0-9.!#$%&' . "'" . '*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$" id="user_email" title="you@domain.com" placeholder="Email address" class="form-control" required="required"') ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('user_phone',  set_value('user_phone'), 'pattern="^(\(?\+?[0-9]*\)?)?[0-9_\- \(\)]*$" id="user_phone" title="Enter Valid Phone Number" min="8" max="15" placeholder="Phone Number" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="step-pane" id="step2">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('brand_name',  set_value('brand_name'), 'id="brand_name" placeholder="Brand Name" class="form-control" required="required"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="brand_tagline" class="col-md-2 col-md-offset-1 col-sm-3 control-label hidden-xs">Brand Slogan: </label>
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('brand_tagline',  set_value('brand_tagline'), 'id="brand_tagline" placeholder="Brand Slogan" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                          ...
                          <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_dropdown('time_zone', $option, set_value('time_zone'),'class="form-control" id="time_zone"') ?>
                                </div>
                          </div>
                            <div class="form-group">
                    ...
                    <div class="step-pane" id="step3">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('fb',  set_value('fb'), 'id="fb" placeholder="Facebook Page Link" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="youtube" class="col-md-2 col-md-offset-1 col-sm-3 control-label hidden-xs">You Tube: </label>
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('youtube',  set_value('youtube'), 'id="youtube" placeholder="You Tube Video Link" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="twitter" class="col-md-2 col-md-offset-1 col-sm-3 control-label hidden-xs">Twitter: </label>
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('twitter',  set_value('twitter'), 'id="twitter" placeholder="Twitter Link" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="googleplus" class="col-md-2 col-md-offset-1 col-sm-3 control-label hidden-xs">Google+: </label>
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('googleplus',  set_value('googleplus'), 'id="googleplus" placeholder="Google Plus Link" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="flickr" class="col-md-2 col-md-offset-1 col-sm-3 control-label hidden-xs">Flickr: </label>
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('flickr',  set_value('flickr'), 'id="flickr" placeholder="Flickr Link" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pinterest" class="col-md-2 col-md-offset-1 col-sm-3 control-label hidden-xs">Pinterest: </label>
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('pinterest',  set_value('pinterest'), 'id="pinterest" placeholder="Pinterest Link" class="form-control"') ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('wc_msg_head',  set_value('wc_msg_head'), 'id="wc_msg_head" placeholder="Welcome Message Head" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="step-pane" id="step5">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                <?=form_dropdown('pp_status', ['0' => 'Live', '1' => 'Sandbox'], set_value('pp_status'), 'id="pp_status" class="form-control"')?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pp_username" class="col-sm-4 control-label hidden-xs">Paypal Username: </label>
                                <div class="col-sm-7 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('pp_username',  set_value('pp_username'), 'id="pp_username" placeholder="Paypal API Username" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pp_pass" class="col-sm-4 control-label hidden-xs">Paypal Password: </label>
                                <div class="col-sm-7 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('pp_pass',  set_value('pp_pass'), 'id="pp_pass" placeholder="Paypal API Password" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pp_sign" class="col-sm-4 control-label hidden-xs">Paypal API Signature: </label>
                                <div class="col-sm-7 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('pp_sign',  set_value('pp_sign'), 'id="pp_sign" placeholder="Paypal API Signature" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('support_email',  set_value('support_email'), 'pattern="^[a-zA-Z0-9.!#$%&' . "'" . '*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$" id="support_email" title="you@domain.com" placeholder="Email address" class="form-control" required="required"') ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?=form_input('support_phone',  set_value('support_phone'), 'pattern="^(\(?\+?[0-9]*\)?)?[0-9_\- \(\)]*$" id="support_phone" title="Enter Valid Phone Number" min="8" max="15" placeholder="Phone Number" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-offset-3 col-sm-8 col-xs-offset-2 col-xs-9">
    ...
    <script src="<?=base_url('assets/fuelux/js/loader.min.js') ?>"></script>
    <script>
