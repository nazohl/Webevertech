...
<div class="block">
    ...
    <?=form_open_multipart(base_url('index.php/course/add_exam/'. $course_id), 'id="upload-form" role="form" class="form-horizontal"'); ?>
    <div class="row">
    <div class="col-sm-12">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <label for="section" class="col-sm-offset-0 col-md-2 col-xs-offset-1 col-xs-3 control-label mobile">Select Exam:</label>
                <div class="col-sm-8 col-xs-7 col-mb">
                    <?php echo form_dropdown('exam', $exam_option,'', 'id="exam_section" class="form-control" required') ?>
                </div>
            </div>
            <?php } ?>
            <div class="form-group">
