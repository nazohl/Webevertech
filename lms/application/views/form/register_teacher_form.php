                    ...
                    <?=form_open(base_url('index.php/login_control/register'), 'role="form" class="form-horizontal"'); ?>
                        <div class="row">
                            <div class="col-md-12 minpadding">
                                ...
                                <?=form_input('paypal_id', '', 'id="paypal_id" type="email" pattern="^[a-zA-Z0-9.!#$%&'."'".'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$" title="you@domain.com" placeholder="PayPal email address *" class="form-control" required="required"') ?>
