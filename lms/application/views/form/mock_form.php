        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                    <?=form_input('mock_title', '', 'placeholder="Exam Title" class="form-control" required="required"') ?>
                </div>
            </div>
            <?php
            $option = array();
                ...
                <div class="col-lg-6 col-sm-9 col-xs-7 col-mb">
                    <select name="course_id" class="form-control">
                        ...
                        foreach ($courses as $course) {
                            if($course->created_by == $this->session->userdata('user_id'))
                            {
                            ?>
            ...
            <div class="form-group">
                ...
                <p class="help-block info"><i class="glyphicon glyphicon-warning-sign"></i> Time format: hh:mm:ss</p>
            </div>
            <div class="form-group">
