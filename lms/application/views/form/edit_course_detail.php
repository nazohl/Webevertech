...
<div class="block">
    <div class="navbar block-inner block-header">
        <div class="row"><p class="text-muted">Update Course </p></div>
    </div>
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8 col-sm-8 col-xs-7 col-mb">
                    <?=form_input('course_title', $courses->course_title, 'placeholder="Course Title" class="form-control" required="required"') ?>
                </div>
            </div>
            <div class="form-group">
